  ...
  <body class="fundo">
    ...
    <div class="container areaGeral">
       <div class="areaBarraProgresso">
        <progress class="barraProgresso" value="37.5" max="100"></progress>
      </div>
        <div class="row justify-content-md-center">
          <h1 class="titulos">Question 3</h1>
        </div>
          <div class="row justify-content-md-center">
          <h4 class="format-text-h1" style="font-size: 40px">Who studies space?</h4>
        </div>
        <div class="row justify-content-md-center">
